...
namespace Modules\WalletModule\Http\Controllers;
...
class WalletModuleController extends Controller
{
    ...
    {
        $wallets=Wallet::get();
        return view('walletmodule::dashboard.wallets.index',compact('wallets'));
    }
    ...
    {
        $users =User::get();
        return view('walletmodule::dashboard.wallets.create',compact('users'));
    }
    ...
    public function edit($id)
    {
        ...
        $users =User::get();
        return view('walletmodule::dashboard.wallets.edit',['wallet'=>$wallet,'users'=>$users]);
    }
